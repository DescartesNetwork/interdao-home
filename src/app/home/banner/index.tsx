...
import BANNER_LIGHT from "static/images/pic_governance_light.png";
import BANNER_DARK from "static/images/pic_governance_dark.png";
    ...
    <Row gutter={[24, 24]} className="banner">
      <Col md={24} lg={12}>
        <Row gutter={[32, 32]} justify="start">
          <Col span={24}>
            <Typography.Text className="banner-header">
              Start building
            </Typography.Text>
          </Col>
          <Col span={24}>
